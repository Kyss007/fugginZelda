...
public class verticalCubeMenuDebug : MonoBehaviour
{
    public inventoryMenuInputThing mainMenuInputThing;
    ...
    private void handleInput()
    {
        if (isVertical)
        {   
            Transform currentChild = menuOptionsParent.GetChild(currentSelectedValue);
            targetTransform = currentChild.GetComponent<RectTransform>();
            ...
            if (acceptAction.action.triggered)
            {
                ...
                if (currentChild.TryGetComponent(out sliderSelector sliderSel))
                {
                    currentSliderSelector = sliderSel;
                    isVertical = false;
                }
                
                else if (currentChild.TryGetComponent(out toggleSelector toggleSel))
                {
                    toggleSel.onTriggered?.Invoke();
                }
            }
        }
        else
