...
namespace PhysicalWalk
{
    public partial class DampedSpringMotionCopier : MonoBehaviour
    {
        ...
        /// Positional stuff
        [System.Serializable]
        public class PositionalSpringTweaksAndState
        {
        ...
        /// Rotational stuff
        [System.Serializable]
        public class RotationalSpringTweaksAndState
        {
            [TooltipAttribute("The object to copy the motion from via the spring.")]
            public Transform sourceObject;
        ...
        {
            if (positionalSpring.sourceObject == null || positionalSpring.motionCopyingType == eMotionCopyingType.NO_MOTION_COPYING)
                return;
            ...
            for (int d = 0; d < 3; d++)
            {
                float newRelPos_d, newSpringVel_d;
                DampedSpringGeneralSolution(
                     out newRelPos_d, out newSpringVel_d,
                ...
                newRelativePosition[d] = newRelPos_d;
                positionalSpring.springVelocity[d] = newSpringVel_d + (positionalSpring.applySpringInMovingReferenceFrame ? sourceVelocity[d] : 0.0f);
            }
        ...
        {
            if (rotationalSpring.sourceObject == null || rotationalSpring.motionCopyingType == eMotionCopyingType.NO_MOTION_COPYING)
                return;
